...
final class AppDelegate: NSObject, NSApplicationDelegate, NSPopoverDelegate {
    ...
    private func checkAndSwapIfNeeded() {
        ...
        let activeNeedsRelief = activeSnapshot.map {
            $0.fiveHour.shouldAutoSwapAway || $0.weekly.shouldAutoSwapAway
        } ?? false
        ...
        if !manualOverrideActive,
           let upgrade = SwapEngine.selectPlanUpgradeCandidate(active: active, from: accountManager.accounts) {
