...
before publication. The repository Cargo build has a hard ten-minute deadline
...
path. Explicit source preparation has a ten-minute maximum and one Cargo job.
