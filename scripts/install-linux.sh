...
SYSTEMD_START_BARRIER_HELPER="${CODEXSWITCH_SYSTEMD_START_BARRIER_HELPER:-$INSTALLER_SCRIPT_DIR/lib/systemd-start-barrier.py}"
...
LINUX_ARTIFACT_VERIFIER="$INSTALLER_SCRIPT_DIR/verify_linux_runtime_artifact.py"
...
LINUX_ARTIFACT_DIR="${CODEXSWITCH_LINUX_ARTIFACT_DIR:-${CODEXSWITCH_CODEX_RUNTIME_DIR:-}}"
CODEX_RUNTIME_DIR="$LINUX_ARTIFACT_DIR"
RUNTIME_STORAGE_ROOT="${CODEXSWITCH_RUNTIME_STORAGE_ROOT:-${CODEX_HOME:-$HOME/.codex}}"
REQUESTED_CODEX_VERSION="${CODEXSWITCH_CODEX_VERSION:-}"
REQUESTED_CODEX_SOURCE_SHA="${CODEXSWITCH_CODEX_SOURCE_SHA:-}"
CODEX_VERSION=""
CODEX_SOURCE_SHA=""
SOURCE_PATCH_SHA256=""
ARTIFACT_BUILD_VERSION=""
ARTIFACT_BUILD_EPOCH=""
